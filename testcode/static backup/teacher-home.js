            ...
            $.post('/api/getlectures',
                 ...
                 function(data){
                   ...
                   $("#latest").hide("slide", { direction: "up" }, 500);
                    setTimeout(
                      function(){$("#create-lecture").remove();
                        $("#latest").html('<ul class="breadcrumb" id="rightm"><li > <span style="font-weight:900">Your lectures &nbsp &nbsp &nbsp </span> <div class="btn-group in"> <button class="btn create-classteacher" type="button" id="create-lecture"> <i class="icon-pencil"></i> Create a lecture</button> </div> <div id="forerror"> </div> </ul><span style="-webkit-column-count:3"><ul class="nav nav-tabs nav-stacked" id="lecturelist"></ul></span>')
                          if (number==0) 
                            {
           ...
           function(data){                    
                     ...
                     if (isOkay==false)
                       ...
                       { color = "green"
                        ...
                        setTimeout(function(){$("#dialog-formlecture").dialog( "close" )
                        $("#forerror").remove();
